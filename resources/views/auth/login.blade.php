            ...
            <div class="row">
                ...
                <div class="col-md-5 col-xl-4 text-center text-md-start">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        @csrf
                        <div class="mb-3">
                            <input id="email" type="email" class="shadow form-control @error('email') is-invalid @enderror" placeholder="Nim/Nippk/no.telp" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                            @error('email')
